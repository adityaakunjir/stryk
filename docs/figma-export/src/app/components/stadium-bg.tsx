export function StadiumBg() {
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      />
      {/* Stadium lights */}
      <div className="absolute top-0 left-1/4 w-px h-40 bg-gradient-to-b from-[var(--stryk-lime)]/40 to-transparent" />
      <div className="absolute top-0 right-1/4 w-px h-40 bg-gradient-to-b from-[var(--stryk-lime)]/40 to-transparent" />
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-[var(--stryk-lime)] blur-md opacity-60" />
      {/* Subtle grid floor */}
      <div
