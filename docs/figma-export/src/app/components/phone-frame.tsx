  ...
  return (
    <div className="flex flex-col items-center gap-4 shrink-0">
      <div className="flex items-baseline gap-3 px-2">
        <div
          className="font-display text-[var(--stryk-lime)] tracking-[0.3em]"
      ...
      >
        ...
        >
          ...
          <div className="absolute top-2 left-1/2 -translate-x-1/2 w-24 h-6 rounded-full bg-black z-50 flex items-center justify-end pr-3">
            <div className="w-1.5 h-1.5 rounded-full bg-[#C6FF00]/70" />
          </div>
          {/* Status bar */}
          <div className="absolute top-3 left-0 right-0 z-40 px-6 flex items-center justify-between text-[10px] text-white/80 tracking-wider">
            <span>9:41</span>
