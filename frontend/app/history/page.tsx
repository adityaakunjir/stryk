          ...
          <div className="flex-1 flex flex-col items-center justify-center relative">
            ...
            >
              ...
              <motion.button
                ...
                className="w-full h-14 rounded-2xl bg-[#D4F829] text-[#151515] font-display text-[14px] font-bold tracking-[0.2em] uppercase flex items-center justify-center gap-2 cursor-pointer shadow-[0_0_30px_-5px_rgba(212,248,41,0.4)]"
              >
