      ...
      <DndContext sensors={sensors} onDragStart={handleDragStart} onDragMove={handleDragMove} onDragEnd={handleDragEnd} onDragCancel={clearActiveDrag} modifiers={[snapCenterToCursor]}>
        <div className="flex flex-col flex-1 relative bg-transparent">
          ...
          <div ref={pitchRef} className="flex-1 relative" 
            ...
            {/* Pitch Lines Wrapper */}
            <div className="absolute inset-x-4 top-[4.5rem] bottom-[4.5rem] border-[1.5px] border-white/35 pointer-events-none shadow-[inset_0_0_40px_rgba(0,0,0,0.18)]" />
            ...
            {/* Top Penalty Box */}
            <div className="absolute top-[4.5rem] left-1/2 w-40 h-20 border-[1.5px] border-t-0 border-white/40 -translate-x-1/2 pointer-events-none" />
            {/* Top 6-yard Box */}
            <div className="absolute top-[4.5rem] left-1/2 w-20 h-8 border-[1.5px] border-t-0 border-white/40 -translate-x-1/2 pointer-events-none" />
            {/* Top Penalty Arc */}
            <svg className="absolute top-[calc(4.5rem+5rem)] left-1/2 h-12 w-24 -translate-x-1/2 pointer-events-none overflow-visible" viewBox="0 0 96 48" aria-hidden="true">
              <path d="M0 0 Q48 48 96 0" fill="none" stroke="rgba(255,255,255,0.40)" strokeWidth="1.5" vectorEffect="non-scaling-stroke" />
            </svg>

            {/* Bottom Penalty Box */}
            <div className="absolute bottom-[4.5rem] left-1/2 w-40 h-20 border-[1.5px] border-b-0 border-white/40 -translate-x-1/2 pointer-events-none" />
            {/* Bottom 6-yard Box */}
            <div className="absolute bottom-[4.5rem] left-1/2 w-20 h-8 border-[1.5px] border-b-0 border-white/40 -translate-x-1/2 pointer-events-none" />
            {/* Bottom Penalty Arc */}
            <svg className="absolute bottom-[calc(4.5rem+5rem)] left-1/2 h-12 w-24 -translate-x-1/2 pointer-events-none overflow-visible" viewBox="0 0 96 48" aria-hidden="true">
