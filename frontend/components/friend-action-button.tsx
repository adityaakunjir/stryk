...
export function FriendActionButton({ targetUserId, initialStatus, requestId }: FriendActionButtonProps) {
  ...
  if (status === "accepted") {
    return (
      <button disabled className="w-full h-12 rounded-2xl border border-[#D4F829]/30 bg-[#D4F829]/10 text-[#D4F829] font-display tracking-[0.15em] text-xs uppercase flex items-center justify-center gap-2">
        <UserCheck size={16} />
        FRIENDS
      </button>
    );
    ...
    return (
      <div className="flex gap-2 w-full">
        <button
          ...
          disabled={isLoading}
          className="flex-1 h-12 rounded-2xl bg-[#D4F829] text-[#151515] font-display tracking-[0.15em] text-xs font-bold uppercase flex items-center justify-center gap-2 hover:bg-[#c5e625] transition disabled:opacity-50 shadow-[0_10px_20px_-10px_rgba(212,248,41,0.4),inset_0_1px_0_rgba(255,255,255,0.4)] active:scale-95"
        >
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="w-full h-12 rounded-2xl bg-[#D4F829] text-[#151515] font-display tracking-[0.15em] text-xs uppercase font-bold flex items-center justify-center gap-2 cursor-pointer hover:bg-[#c5e625] transition duration-200 shadow-[0_15px_30px_-10px_rgba(212,248,41,0.5),inset_0_1px_0_rgba(255,255,255,0.5)] disabled:opacity-50 active:scale-95"
    >
